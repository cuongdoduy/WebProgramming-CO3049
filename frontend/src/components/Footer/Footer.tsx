    ...
    <footer className="relative w-full  bg-black">
      <div className="mx-auto w-full max-w-8xl px-8">
        <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-5">
          <div className="w-full">
            ...
            <ul className="space-y-1">
              ...
              <Typography as="li" color="blue-gray" className="font-normal">
                <div className="inline-block py-1 pr-2 text-white">
                  <form className="max-w-md mx-auto flex border border-gray-300 rounded-md bg-transparent pl-0">
                    <div className="relative bg-transparent mr-4">
                      <input
                        type="search"
                        id="default-search"
                        className="block w-full text-sm bg-transparent h-full focus:outline-none pl-4"
        ...
        <div className="flex w-full flex-col items-center justify-center py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal text-blue-gray-900 md:mb-0 text-white w-full opacity-50">
            &copy; {currentYear}{' '}
            <a href="https://material-tailwind.com/">Exclusive</a>. All Rights
            Reserved.
          </Typography>
        </div>
      </div>
